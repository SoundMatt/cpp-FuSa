...
|---|---|---|---|---|---|
| TARA-001 | cpp-FuSa release binary | Attacker replaces a signed release binary with a trojaned build that suppresses safety findings before it reaches a downstream project's CI. | low | medium | mitigate |
