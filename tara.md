...
Generated: 2026-06-10T19:14:33Z

| ID | Asset | Threat | Feasibility | Impact | Risk | Level | Treatment |
|---|---|---|---|---|---|---|---|
| TS-001 | cpp-FuSa binary | Tampering with build artifacts | 2 | 4 | 8 | medium | mitigate |
| TS-002 | Configuration (.fusa.json) | Spoofing of safety configuration | 2 | 3 | 6 | medium | mitigate |
| TS-003 | cpp-FuSa CLI interface | Information disclosure via verbose output | 1 | 2 | 2 | low | accept |
